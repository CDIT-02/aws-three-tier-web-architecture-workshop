...
## TO BE DONE
1. Replace API URL for nginx.conf with the created private load balancer DNS 
2. In App tier source code, Dbconfig.js file, replace the DB server details with the newly created one
